...
export const vulnerabilityCategories = [
  {
    ...
    description:
      "Inyección de código JavaScript malicioso en páginas web que se ejecuta en el navegador de otros usuarios. Permite robo de cookies, sesiones y ejecución de acciones en nombre del usuario.",
  },
  {
    id: "csrf",
    title: "Cross-Site Request Forgery (CSRF)",
    description:
      "Ataques que fuerzan a usuarios autenticados a ejecutar acciones no deseadas en aplicaciones web. Explota la confianza del navegador para enviar solicitudes maliciosas.",
  },
  {
    id: "file-upload",
    title: "File Upload Vulnerabilities",
    description:
      "Vulnerabilidades que permiten cargar archivos maliciosos al servidor sin validación adecuada. Puede llevar a ejecución remota de código y compromiso del servidor.",
  },
  {
    id: "path-traversal",
    title: "Path Traversal",
    description:
      'Técnica que permite acceder a archivos y directorios fuera del directorio web permitido. Usa secuencias como "../" para navegar por el sistema de archivos.',
  },
  {
    id: "sql-injection",
    title: "SQL Injection",
    description:
      "Inyección de código SQL malicioso en consultas de base de datos. Permite acceder, modificar o eliminar datos sensibles sin autorización adecuada.",
  },
  {
    id: "ssti",
    title: "Server-Side Template Injection",
    description:
      "Inyección de código en plantillas del servidor que se procesan dinámicamente. Puede llevar a ejecución remota de código y control completo del servidor.",
  },
  {
    id: "idor",
    title: "IDOR (Insecure Direct Object Reference)",
    description:
      "Vulnerabilidad que permite acceder a recursos sin autorización al manipular referencias directas a objetos. Los usuarios pueden acceder a datos de otros usuarios.",
  },
  {
    id: "ssrf",
    title: "SSRF (Server-Side Request Forgery)",
    description:
      "Vulnerabilidad que permite a atacantes hacer solicitudes HTTP desde el servidor a recursos internos. Puede exponer servicios internos y datos sensibles.",
  },
  {
    id: "auth-bypass",
    title: "Authentication Bypass",
    description:
      "Técnicas para evadir o saltarse los mecanismos de autenticación de una aplicación. Incluye bypass de login, sesiones débiles y enumeración de usuarios.",
  },
];
